...
            <div className='us-btn-txt action-card'>
                    ...
                    <div className='action-wrapper'>
                        <div onClick={() => this.props.sickWorker('tester', 5)} className='button button-white dice-button'><div className='us-btn-txt'><img className='btn-img' src='../img/dice.svg' /><span className='btn-txt'>Roll the dice</span></div></div>
